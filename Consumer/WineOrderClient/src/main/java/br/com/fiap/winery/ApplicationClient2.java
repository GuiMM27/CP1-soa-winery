...
public class ApplicationClient2 {
    public static void main(String[] args) throws Exception {
        ...
        // --- PARTE 1: FAZENDO O PEDIDO (Porta 8085) ---
        ...
        System.out.println("Status do Pedido: " + order);


        // --- PARTE 2: CONSULTANDO O AVISO (Porta 8086) ---
        ...
        System.out.println("Aviso do Sistema: " + warn);
    }
}